...
class LookFeel extends JFrame implements ItemListener {
  ...
  JTextField t;
    ...
    // create button group obejct and add radio buttons to specify that they belong to same group
    bg=new ButtonGroup();
    bg.add(r1);
   bg.add(r2);
   bg.add(r3);
...
{
   try {
             //know that which radio button clicked and change look and feel accordingly
